...
(
  ...
  current_timestamp,
  current_timestamp,
  '{"provider":"email","providers":["email"],"org_roles":{"11111111-1111-1111-1111-111111111111":"internal_user"}}',
  '{}',
  current_timestamp,
  current_timestamp,
  '',
...
(
  ...
  current_timestamp,
  current_timestamp,
  '{"provider":"email","providers":["email"],"org_roles":{"11111111-1111-1111-1111-111111111111":"portal_user"}}',
  '{}',
  current_timestamp,
  current_timestamp,
  '',
