...
export function TicketFilters() {
  ...
  const updateUrl = useCallback((newFilters: TicketFiltersType) => {
    ...
    <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <Select
          ...
          onValueChange={(value) => handleStatusChange(value as typeof STATUSES[number])}
        >
        ...
        <Select
          value={filters.priority?.length ? filters.priority.join(',') : undefined}
          onValueChange={(value) => handlePriorityChange(value as typeof PRIORITIES[number])}
        >
          <SelectTrigger className="w-[180px]">
